...
<body class="ui-mobile-viewport ui_body_d" text=#000000 bgColor=#ffffff leftMargin=0 topMargin=4>
	<div id="main">
		<div id="head">
            ...
            <div id="body" style="clear:left">
                <dl class="content">
                  ...
                  <dd>
                        ...
                        <input size="25" name="WIDseller_email" value="fyfeifan998@163.com"/>
                        <span></span>
                    </dd>
                    <dt>商户订单号：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="25" name="WIDout_trade_no"  readonly="true" value="<?php echo $_GET['oid']; ?>"/>
                        <span></span>
                    </dd>
                    <dt>订单名称：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="25" name="WIDsubject"  readonly="true" value="富阳友帆贸易有限公司-葡萄美酒"/>
                        <span></span>
                    </dd>
                    <dt>付款金额：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="25" name="WIDtotal_fee" readonly="true" value="<?php echo $_GET['fee']; ?>" />
                        <span></span>
                    </dd>
					<dt></dt>
                    <dd>
